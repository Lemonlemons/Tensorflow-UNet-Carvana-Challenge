...
class Unet128(BaseModel):

  def build(self, stats):
    # image shape
    self.image_input_shape = [128, 128, 3]
    # mask shape
    ...
    with self.GRAPH.as_default():
      ...
      down1, down1_pool = unet_down_layer_group(IMAGES, 'conv_down_64', 3, 64, relu, self.is_training)
      ...
      with tf.variable_scope('output') as scope:
        pred_y_pre_sigmoid = conv2d_layer(up1, shape=[1, 1, 64, 1], scope=scope,
